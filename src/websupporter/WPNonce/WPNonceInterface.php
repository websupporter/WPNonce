...
interface WPNonceInterface {
	 ...
	 * @since 2.0.0
	 *
	 * @param (string)  $new_request The new request name for $_REQUEST;
	 ...
	 * @since 2.0.0
	 *
	 * @param  (boolean) $actual_lifetime Whether to run the 'nonce_life' filter or not. Optional. Default = true
	 * @return (int)     $lifetime     The lifetime
	 **/
